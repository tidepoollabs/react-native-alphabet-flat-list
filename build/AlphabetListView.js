...
class AlphabetListView extends react_1.PureComponent {
    ...
    render() {
        ...
        return (<react_native_1.View style={Object.assign({ position: 'absolute', top: topPosition, right: 5, zIndex: 10, height: contentHeight }, this.props.alphabetListViewStyles)} {...this.responder.panHandlers}>
        {titles.map((title) => (<SectionListItem_1.default key={title} height={itemHeight} title={title} active={selectAlphabet === title} alphabetTextViewStyles={this.props.alphabetTextViewStyles}/>))}
      </react_native_1.View>);
    }
}
